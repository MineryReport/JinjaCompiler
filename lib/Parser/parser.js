...
class Parser {
    ...
    statements(indent = 0) {
        ...
        if (this.currentToken.type === lexer_1.TokenType.TT_EOF) {
            return res.success(new node_1.ListNode(statements, posStart, (_e = (_d = this.currentToken.posEnd) === null || _d === void 0 ? void 0 : _d.copy()) !== null && _e !== void 0 ? _e : this.currentToken.posStart.copy()));
        }
        ...
        if (statements.length > 0) {
            return res.success(new node_1.ListNode(statements, posStart, (_g = (_f = this.currentToken.posEnd) === null || _f === void 0 ? void 0 : _f.copy()) !== null && _g !== void 0 ? _g : this.currentToken.posStart.copy()));
        }
        return res.success(new node_1.ListNode(statements, posStart, (_j = (_h = this.currentToken.posEnd) === null || _h === void 0 ? void 0 : _h.copy()) !== null && _j !== void 0 ? _j : this.currentToken.posStart.copy()));
    }
    expr() {
        let res = new Result_1.default();
